...
class Lexer:
    ...
    def get_next_token(self):
        ...
        while self.current_char is not None:
            ...
            if self.current_char == "*":  # Додано для операції множення
                self.advance()
                return Token(TokenType.MUL, "*")

            if self.current_char == "/":  # Додано для операції ділення
                self.advance()
                return Token(TokenType.DIV, "/")

            if self.current_char == "(":  # Додано для відкриваючої дужки
                self.advance()
                return Token(TokenType.LPAREN, "(")

            if self.current_char == ")":  # Додано для закриваючої дужки
                self.advance()
...
class Parser:
    ...
    def factor(self):
        """
        Парсер для факторів. Факторами є цілі числа або вирази у дужках.
        """
    ...
    def term(self):
        """
        Парсер для 'term' правил граматики. Тепер включає обробку множення та ділення.
        """
        node = self.factor()
